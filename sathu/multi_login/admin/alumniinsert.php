...
<body>
       <img src="admin5.jpg" width="1550" height="550" align="center">
...
$sql="insert into alumni(name,num,stream,course,player,sport,year,medal,occupation) values ('$n','$rollno','$str','$course','$play','$sprt','$yrs','$mdls','$occu')";
$conn->exec($sql);
